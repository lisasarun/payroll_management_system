...
public class AdminController {
    ...
    private void addEmployee() {
        ...
        if (empService.addEmployee(emp))
            ...
            ViewUtil.printError("Failed to add employee.");
    }
    ...
    private void updateEmployee() {
        ...
        emp.setBaseSalary(salStr.isEmpty() ? dto.getBaseSalary()
                                           : new BigDecimal(salStr));

        if (empService.updateEmployee(emp))
            ViewUtil.printSuccess("Employee updated.");
        else
            ViewUtil.printError("Update failed.");
    }
    ...
    private void searchEmployee() {
        ...
        if (list.isEmpty()) { ViewUtil.printInfo("No results."); return; }
    ...
    private void disableEmployee() {
        ...
        else                                ViewUtil.printError("Failed.");
    }
    ...
    private void listEmployees() {
        ...
        while (running) {
            ...
            String ch = InputUtil.readMenuChoice("");
    ...
    private void addBonus() {
        ...
        if (bonusService.addBonus(id, amount, reason))
            ViewUtil.printSuccess("Bonus added.");
        else
    ...
    private void viewBonuses() {
        ...
        if (bonuses.isEmpty()) { ViewUtil.printInfo("No bonuses found."); return; }

        ViewUtil.printTitle("BONUSES — " + dto.getFullName());
        System.out.printf("  %-10s %-12s %-30s%n", "Date", "Amount", "Reason");
        System.out.println("  " + "-".repeat(54));
        bonuses.forEach(b -> System.out.printf("  %-10s $%-11.2f %-30s%n",
